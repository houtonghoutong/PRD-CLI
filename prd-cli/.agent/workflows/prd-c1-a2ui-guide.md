...
3. PM 回答："REQ-001"
   ↓
4. AI 正式保存：
   - 将 `.a2ui/current.json` 的内容复制到
     `02_迭代记录/第XX轮迭代/C1_UI原型/REQ-001-界面名称.json`
   - 更新 `index.md` 索引文件
   ↓
5. AI 确认：
   "✅ 界面原型已正式保存！
    
    📁 文件位置：02_迭代记录/第01轮迭代/C1_UI原型/REQ-001-登录页.json
...
| 需求编号 | 界面名称 | 原型文件 | 确认时间 |
|---------|---------|---------|---------|
| REQ-001 | 登录页 | [REQ-001-登录页.json](./REQ-001-登录页.json) | 2025-12-27 |
| REQ-002 | 首页看板 | [REQ-002-首页看板.json](./REQ-002-首页看板.json) | 2025-12-27 |
```
